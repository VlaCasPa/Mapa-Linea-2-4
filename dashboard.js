// Registramos el plugin DataLabels para que los porcentajes se dibujen sobre el gráfico circular
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    Papa.parse(urlCSV, {
        ...
        complete: function(results) {
            ...
            // Arreglos de Tablas y Gráficos
            let tablaUrgente = [];
            let tablaObraTramite = [];
            let tablaDesvioTramite = [];
            let chartIdsData = [];
            ...
            results.data.forEach(item => {
                ...
                [evO, evD].forEach(ev => {
                    ...
                    // Conteo Lookahead (Próximos a vencer)
                ...
                // Acumulador de IDs para el Gráfico Mixto (Obras y Desvíos sumados por severidad)
            ...
            new Chart(document.getElementById('chart-portafolio'), {
                ...
                options: {
                    ...
                    layout: { padding: { top: 10, bottom: 10, left: 10, right: 30 } } // Espacio para que las etiquetas no se corten
                }
            });

            // 2. GRÁFICO BARRAS APILADAS (Jurisdicción)
            ...
            // 3. GRÁFICO LOOKAHEAD (Vencimientos a Futuro)
            ...
            // 4. GRÁFICO MATRIZ ID (Top Críticos)
            chartIdsData.sort((a, b) => a.minDias - b.minDias); // Ordenar de más negativo a menos
            ...
            const poblarTabla = (idTbody, data, isUrgente) => {
                ...
                data.sort((a, b) => a.dias - b.dias).slice(0, 5).forEach(d => { // Top 5 para encajar en A4
    ...
    document.getElementById('btn-exportar-pdf').addEventListener('click', (e) => {
        ...
        const opt = {
            ...
            html2canvas: { scale: 2, useCORS: true, windowWidth: 794 }, // Fuerza el render a tamaño A4 web
